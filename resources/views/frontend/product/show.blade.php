            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        ...
                        <div><span class="product__details__price">{{ $data['product']->price }}</span> <br> <span class="product__details__sale_price"><s>{{ $data['product']->sale_price }}</s></span></div>
                        @csrf
            ...
            <div class="row">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                ...
                @slot('route', route('product.show', ['categoriSlug' => $product_related->Category->slug, 'productSlug' =>
                    ...
                    @slot('sale_price', $product_related->sale_price)
                    @slot('discount', $product_related->discount)
                @endcomponent
                </div>
               @endforeach
            </div>
