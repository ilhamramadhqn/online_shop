        ...
        <div class="col-12">
            @component('components.backend.card.card-form')
                ...
                @slot('content')
                    ...
                    <x-forms.input class="col-6" type="number" name="sale_price" id="sale_price" :label="__('Harga Jual')" :isRequired="true" />

                    <x-forms.select name="discount" id="discount" label="{{ __('button.select') }} {{ __('menu.category') }}" :isRequired="true">
                        <option value="" selected disabled>Pilih Status Product</option>
