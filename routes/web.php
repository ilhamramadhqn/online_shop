...
use App\Http\Controllers\Backend\Master\CareerController;
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::prefix('master')->name('master.')->group(function(){
            ...
            Route::prefix('category')->name('category.')->group(function(){
                ...
                Route::get('/delete/{idç}',[CategoryController::class,'delete'])->name('delete');
                Route::get('/edit/{id}',[CategoryController::class,'edit'])->name('edit');
                Route::post('/update/{id}',[CategoryController::class,'update'])->name('update');
                Route::get('/show/{id}',[CategoryController::class,'show'])->name('show');
            });
            
            Route::prefix('mastercareer')->name('category.')->group(function(){
                Route::get('/',[CareerController::class,'index'])->name('index');
                Route::get('/create',[CareerController::class,'create'])->name('create');
                Route::post('/create',[CareerController::class,'store'])->name('store');
                Route::get('/delete/{id}',[CareerController::class,'delete'])->name('delete');
                Route::get('/edit/{id}',[CareerController::class,'edit'])->name('edit');
                Route::post('/update/{id}',[CareerController::class,'update'])->name('update');
                Route::get('/show/{id}',[CareerController::class,'show'])->name('show');
            });
...
Route::middleware('auth','role:user')->group(function(){
    ...
    Route::prefix('account')->name('account.')->group(function(){
        Route::get('/',[AccountController::class,'create'])->name('index');
        Route::post('/account_setting',[AccountController::class,'store'])->name('account_setting');
    });
...
Route::get('/populer', [FrontendProductController::class,'index2'])->name('populer.index2');
Route::get('/terbaru', [FrontendProductController::class,'index3'])->name('terbaru.index3');
Route::get('/terlaris', [FrontendProductController::class,'index4'])->name('terlaris.index4');
